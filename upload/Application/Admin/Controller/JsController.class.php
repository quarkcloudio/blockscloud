 ...
 */
class JsController extends PublicController {
    ...
    public function common_js(){
        ...
        $the_config = array(
            ...
            'json_data'     => "",
            'theme'         => "simple\/", //列表排序依照的字段
            'list_type'     => "icon", //列表排序依照的字段
        ...
        $L= array(
            ...
            'copyright_contact'             =>'授权或定制请联系QQ:<a href="http://wpa.qq.com/msgrd?v=3&uin=869716224&site=qq&menu=yes" target="_blank">869716224</a><a href="javascript:core.openIE(\'http://ixiaoquan.com\');">问题反馈</a>',
            "copyright_info"            =>'Copyright © <a href="http://ixiaoquan.com/" target="_blank">ixiaoquan.com</a> All rights reserved.',
            "copyright_pre"             =>'Powered by BlocksCloud',
            "kod_name"                  => "积木云",
            "kod_name_desc"             => "积木云WEB3.0",
            "kod_power_by"              => " - Powered by BlocksCloud",
            "kod_name_copyright"        => "积木云WEB3.0",
