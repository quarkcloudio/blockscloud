                        ...
                        for (var i = [], n = a.length, s = 0, o = e, r = 0; n > r; r++) {
                            ...
                            if (! (2 > c.length) && c[t.reg_index]) {
                                ...
                                if (l.pos_start = s + d + p, l.pos_end = l.pos_start + l.name.length, "object" == typeof t.reg_name_all) {
                                    l.name = "";
                                    for (var u = t.reg_name_all,
                                             h = 0; u.length > h; h++) l.name += c[u[h]]
                                }
            ...
            var s = function(e, t) {
                ...
                r = function(e) {
                    ...
                    var s = art.dialog({
                        ...
                        o = "./admin.php?s=/editor/fileGet&filename=" + e;
                    G.share_page !== void 0 && (o = "./admin.php?s=/share/fileGet&user=" + G.user + "&sid=" + G.sid + "&filename=" + e),
                        $.ajax({
                            dataType: "json",
                            url: o,
                            ...
                            success: function(e) {
                                if (s.close(), !e.code) return Tips.tips(e),
                                    _(t.uuid),
                                    void 0;
                                var n = e.data;
                                a[i] = void 0,
                ...
                u = function(e, i, n) {
                    ...
                    o && $.ajax({
                        url: "./admin.php?s=/editor/setConfig&k=" + o.k + "&v=" + o.v,
                        dataType: "json",
                        success: function() {}
                    })
                },
                    ...
                    if (void 0 != i) {
                        ...
                        if (n.hasChanged) {
                            ...
                            var s = urlEncode2(n.getValue()),
                                o = n.kod.filename,
                                r = "./admin.php?s=/editor/fileSave";
                            G.share_page !== void 0 && (r = "./admin.php?s=/share/fileSave&user=" + G.user + "&sid=" + G.sid + "&filename=" + o),
                                $.ajax({
                                    type: "POST",
                                    dataType: "json",
                                    url: r,
