define("app/src/explorer/main", ["lib/jquery-lib", "lib/util", "lib/ztree/js/ztree", "lib/contextMenu/jquery-contextMenu", "lib/artDialog/jquery-artDialog", "lib/picasa/picasa", "./ui", "./fileSelect", "../../common/taskTap", "../../common/core", "../../tpl/copyright.html", "../../tpl/search.html", "../../tpl/search_list.html", "../../tpl/upload.html", "../../common/rightMenu", "../../common/tree", "../../common/pathOperate", "../../tpl/fileinfo/file_info.html", "../../tpl/fileinfo/path_info.html", "../../tpl/fileinfo/path_info_more.html", "../../tpl/share.html", "../../tpl/app.html", "../../common/pathOpen", "../../common/CMPlayer", "./path"],
    function(e) {
        Config = {
            ...
            TreeId: "folderList",
            pageApp: "explorer",
            treeAjaxURL: "./admin.php?s=/explorer/treeList&app=explorer",
            AnimateTime: 200
        },
            Global = {
                fileListAll: "",
            ...
            $(document).ready(function() {
                Global.topbar_height = "none" == $(".topbar").css("display") ? 0 : $(".topbar").height(),
    ...
    define("app/src/explorer/ui", ["./fileSelect"],
        function(require, exports) {
            ...
            var _ajaxLive = function() {
                ...
                _setListType = function(e, t) {
                    G.list_type = e,
                        void 0 == t ? $.ajax({
                            url: "./admin.php?s=/setting/set&k=list_type&v=" + e,
                            dataType: "json",
                            success: function() {
                                _initListType(e),
                                    _f5(!1, !1)
                ...
                _setListSort = function(e, t) {
                    ...
                    0 != t && (G.sort_order = t, $(".menu_set_desc").removeClass("selected"), $(".set_sort_" + t).addClass("selected")),
                        _f5(!1, !0),
                        $.ajax({
                            url: "./admin.php?s=/setting/set&k=list_sort_field,list_sort_order&v=" + G.sort_field + "," + G.sort_order
                        })
                },
                ...
                _bindEventSort = function() {
                    $("#main_title div").die("click").live("click",
                        function() {
                            "up" == $(this).attr("id") ? $(this).attr("id", "down") : $(this).attr("id", "up"),
                ...
                _bindEventTheme = function() {
                    $(".dropdown-menu-theme li").click(function() {
                        ...
                        $.ajax({
                            url: "./admin.php?s=/setting/set&k=theme&v=" + e,
                            dataType: "json",
                            success: function(t) {
                                ui.setTheme(e),
                                t.code || (core.authCheck("setting:set") ? core.tips.tips(LNG.config_save_error_file, !1) : core.tips.tips(LNG.config_save_error_auth, !1))
                            }
                        }),
                ...
                _bindFrameSizeEvent = function() {
                    var e = !1,
                        ...
                        o = $(".frame-resize"),
                        r = $(".frame-right");
                    o.die("mousedown").live("mousedown",
                        function(e) {
                    ...
                    var l = function(i) {
                        ...
                        c = function(l) {
                            ...
                            var c = l.pageX - t,
                                d = a + c;
                            i > d && (d = i),
                            d > $(document).width() - 200 && (d = $(document).width() - 200),
                                n.css("width", d),
                                s.css("width", d),
                                o.css("left", d - 5),
                                r.css("left", d + 1),
                ...
                _bindHotKey = function() {
                    ...
                    Global.ctrlKey = !1,
                        $(document).keydown(function(t) {
                            ...
                            return a && (stopPP(t), t.keyCode = 0, t.returnValue = !1),
                                !0
                        }).keyup(function(t) {
                            t.shiftKey || (Global.shiftKey = !1),
                            t.keyCode != e && t.ctrlKey || (Global.ctrlKey = !1)
                        })
                },
                _menuActionBind = function() {
                    $(".drop-menu-action li").bind("click",
                        function() {
            ...
            this._hover_title = function(e) {
                return void 0 == e.size_friendly && (e.size_friendly = "0B"),
                ' data-path="' + e.path + '" data-name="' + e.name + '" title="' + LNG.name + ":" + e.name + "&#10;" + LNG.size + ":" + e.size_friendly + "&#10;" + LNG.permission + ":" + e.mode + "&#10;" + LNG.create_time + ":" + e.ctime + "&#10;" + LNG.modify_time + ":" + e.mtime + '" '
            },
                this._getFolderBox = function(e) {
                    var t = "",
                        a = e.name;
                    return "number" == typeof e.exists && 0 == e.exists && (a = '<b style="color:red;">' + a + "</b>"),
                        t += "<div class='file folderBox menufolder' data-name='" + e.name + "'" + _hover_title(e) + ">",
                        t += "<div class='folder ico' filetype='folder'></div>",
                ...
                this._getFileBox = function(e) {
                    ...
                    if ("number" == typeof e.exists && 0 == e.exists && (a = '<b style="color:red;">' + a + "</b>"), "oexe" == e.ext && void 0 != e.icon) {
                        ...
                        a = a.replace(".oexe", ""),
                            t = "<div class='file fileBox menufile' data-app=" + n + " data-name='" + e.name + "'" + _hover_title(e) + ">",
                            "app_link" == e.type ? (t += 0 == e.content.search("ui.path.open") ? "<div class='" + core.pathExt(e.name.replace(".oexe", "")) + " ico'": "<div class='folder ico'", t += ' filetype="oexe"></div><div class="app_link"></div>') : t += "<div class='ico' filetype='oexe' style='background-image:url(" + i + ")'></div>",
                            t += "<div id='' class='titleBox'><span class='title' title='" + LNG.double_click_rename + "'>" + a + "</span></div></div>"
                    } else if (inArray(core.filetype.image, e.ext)) {
                        var s = core.path2url(G.this_path + e.name),
                            o = "./admin.php?s=/explorer/image&path=" + urlEncode(G.this_path + e.name);
                        t += "<div class='file fileBox menufile' " + _hover_title(e) + ">",
                            t += "<div picasa='" + s + "' thumb='" + o + "' title='" + e.name + "' class='picasaImage picture ico' filetype='" + e.ext + "' style='margin:3px 0 0 8px;background:#fff url(\"" + o + "\") no-repeat center center;'></div>",
                            t += "<div id='" + e.name + "' class='titleBox'><span class='title' title='" + LNG.double_click_rename + "'>" + a + "</span></div></div>"
                    } else t += "<div class='file fileBox menufile' " + _hover_title(e) + ">",
                ...
                this._getFolderBoxList = function(e) {
                    ...
                    return a += "   <div class='folder ico' filetype='folder'></div>",
                        ...
                        a += "  <div class='filetype'>" + LNG.folder + "</div>",
                ...
                this._getFileBoxList = function(e) {
                    ...
                    if ("number" == typeof e.exists && 0 == e.exists && (a = '<b style="color:red;">' + a + "</b>"), "oexe" == e.ext) {
                        ...
                        t = "<div class='file fileBox menufile' data-app=" + i + _hover_title(e) + ">",
                            a = a.replace(".oexe", ""),
                            "app_link" == e.type ? (t += 0 == e.content.search("ui.path.open") ? "<div class='" + core.pathExt(e.name.replace(".oexe", "")) + " ico'": "<div class='folder ico'", t += ' filetype="oexe"></div><div class="app_link"></div>') : t += "<div class='oexe ico' filetype='oexe'></div>"
                    } else if (inArray(core.filetype.image, e.ext)) {
                        var n = core.path2url(G.this_path + e.name),
                            s = "./admin.php?s=/explorer/image&path=" + urlEncode(G.this_path + e.name);
                        t += "<div picasa='" + n + "' thumb='" + s + "' class='picasaImage file fileBox menufile'" + _hover_title(e) + ">",
                            t += "  <div class='" + e.ext + " ico' filetype='" + e.ext + "'></div>"
                    } else t += "<div class='file fileBox menufile'" + _hover_title(e) + ">",
                        t += "  <div class='" + e.ext + " ico' filetype='" + e.ext + "'></div>";
                    return t += "   <div id='" + e.name + "' class='titleBox'><span class='title' title='" + LNG.double_click_rename + "'>" + a + "</span></div>",
                        t += "  <div class='filetype'>" + e.ext + "  " + LNG.file + "</div>",
            ...
            var pathTypeChange = function() {
                ...
                _mainSetData = function(e) {
                    ...
                    "list" == G.list_type && $(Config.FileBoxSelector + " .file:nth-child(2n)").addClass("file2"),
                        _ajaxLive()
                },
                _f5 = function(e, t, a) {
                    if (void 0 == e && (e = !0), void 0 == t && (t = !1), _jsonSortTitle(), e) $.ajax({
                        url: "./admin.php?s=/explorer/pathList&path=" + urlEncode(G.this_path),
                        dataType: "json",
                        beforeSend: function() {
                        ...
                        success: function(e) {
                            return $(".tools-left .msg").fadeOut(100),
                                e.code ? (G.json_data = e.data, _f5_time_user(), Global.historyStatus = G.json_data.history_status, _mainSetData(t), pathTypeChange(), ui.header.updateHistoryStatus(), ui.header.addressSet(), rightMenu.menuCurrentPath(G.json_data.path_type), "function" == typeof a && a(e), void 0) : (core.tips.tips(e), $(Config.FileBoxSelector).html(""), !1)
                        },
            ...
            return {
                ...
                setTheme: function(e) {
                    core.setSkin(e, "app_explorer.css"),
                        FrameCall.top("OpenopenEditor", "Editor.setTheme", '"' + e + '"'),
                        FrameCall.top("Opensetting_mode", "Setting.setThemeSelf", '"' + e + '"'),
                        FrameCall.father("ui.setTheme", '"' + e + '"')
                },
                isEdit: function() {
                    var e = $(document.activeElement).get(0);
                    if (e) return e = e.tagName,
                        "INPUT" == e || "TEXTAREA" == e ? !0 : !1
                },
                init: function() {
                    _f5_callback(function() {
                        ...
                        $(window).bind("resize",
                            function() {
                                ui.setStyle(),
                                    ui.header.set_width(),
                                0 != PicasaOpen && MyPicasa.setFrameResize()
                            }),
                        $("html").bind("click",
                            function() {
                                rightMenu.hidden(),
                                Global.isIE && Global.isDragSelect
                            }),
                    ...
                    Mousetrap.bind(["1", "2", "3", "4", "5", "6", "7", "8", "9", "0", "`", "~", "!", "@", "#", "$", "%", "^", "&", "*", "(", ")", "-", "_", "=", "+", "[", "{", "]", "}", "|", "/", "?", ".", ">", ",", "<", "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", "w", "x", "y", "z"],
                        ...
                        Mousetrap.bind(["alt+i", "alt+i"],
                            function(e) {
                                stopPP(e),
                                    ui.path.info()
                            }),
                        Mousetrap.bind(["alt+n", "alt+n"],
                            function(e) {
                                stopPP(e),
                                    ui.path.newFile()
                            }),
                        Mousetrap.bind(["alt+m", "alt+m"],
                            function(e) {
                                stopPP(e),
                                    ui.path.newFolder()
                            }),
                ...
                header: {
                    bindEvent: function() {
                        $("#yarnball li a").die("click").live("click",
                            ...
                            $(".header-right input").die("keyup").live("keyup",
                                function() {
                    ...
                    addressSet: function() {
                        ...
                        var t = function(e) {
                            ...
                            var n = i[0] + "/",
                                s = t.replace(/@1@/g, n),
                                o = i[0];
                            "" != i[0] && ("*share*" == o ? o = LNG.my_share: "*public*" == o ? o = LNG.public_path: "*recycle*" == o && (o = LNG.recycle)),
                                s = s.replace("{$2}", i.length),
                                s = s.replace("{$3}", o);
                            for (var r = s,
                                     l = 1,
                                     c = i.length - 1; i.length > l; l++, c--) n += i[l] + "/",
                                s = a.replace(/@1@/g, n),
                                s = s.replace("{$2}", c),
                                s = s.replace("{$3}", i[l]),
                                r += s;
                    ...
                    updateHistoryStatus: function() {
                        0 == Global.historyStatus.back ? $("#history_back").addClass("active") : $("#history_back").removeClass("active"),
                            0 == Global.historyStatus.next ? $("#history_next").addClass("active") : $("#history_next").removeClass("active")
                    },
                    gotoFather: function() {
                        var e = $("input.path").val();
                        if ("/" == e) return core.tips.tips("已经到根目录了!", "warning"),
                            void 0;
                        var t = e.length - 1,
                            a = "",
                            i = e.split("/").length - 1;
            ...
            var e = !1,
                ...
                n = function() {
                    $(Config.FileBoxClass).die("touchstart").live("touchstart",
                        ...
                        $(Config.FileBoxClass).live("mouseenter",
                            function() {
                                t && $(this).hasClass(Config.TypeFolderClass) && !$(this).hasClass(Config.SelectClassName) && $(this).addClass("selectDragTemp"),
                                e || t || $(this).addClass(Config.HoverClassName),
                            ...
                            function(e) {
                                stopPP(e),
                                e.ctrlKey || e.shiftKey || (d.clear(), $(this).addClass(Config.SelectClassName), d.select()),
                                e.ctrlKey && a && (a = !1, d.resumeMenu($(this)), $(this).removeClass(Config.SelectClassName), d.select())
                            }),
                        $(Config.FileBoxClass).die("dblclick").live("dblclick",
                            function(e) {
                                stopPP(e),
                                    e.altKey ? ui.path.info() : ui.path.open()
                            }),
                        $(Config.FileBoxTittleClass).die("dblclick").live("dblclick",
                            function(e) {
                                return ui.path.rname(),
                                    stopPP(e),
                                    !1
                            })
                },
                    ...
                    var f = function(e) {
                        ...
                        m = function(e) {
                            ...
                            a = 0 >= a ? 0 : a,
                                ...
                                a -= o,
                                r -= l,
                                $(".draggable-dragging").css("left", a),
                                $(".draggable-dragging").css("top", r),
                            Global.isIE && $("." + Config.TypeFolderClass).each(function() {
                                var t = e.pageX,
                                    a = e.pageY,
                                    i = $(this).offset(),
                                    n = $(this).width(),
                        ...
                        v = function(e) {
                            ...
                            t = !1,
                                ...
                                $(".draggable-dragging").fadeOut(200,
                                    function() {
                                        $(this).remove()
                                    });
                            var a = G.this_path,
                        ...
                        _ = function() {
                            p = !0,
                                ...
                                a.find(".ico").attr("filetype"),
                                $('<div class="file draggable-dragging"><div class="drag_number">' + Global.fileListSelectNum + "</div>" + '<div class="ico" style="background:' + a.find(".ico").css("background") + '"></div>' + "</div>").appendTo("body")
                        }
                },
                o = function() {
                    var a = null,
                        ...
                        o = 0,
                        r = 0;
                    $(Config.BodyContent).die("mousedown").live("mousedown",
                        function(e) {
                            if (! ($(e.target).hasClass("bodymain") && 20 > $(document).width() - e.pageX)) {
                                ...
                                this.setCapture && this.setCapture(),
                                    ...
                                    $(document).one("mouseup",
                                        function(e) {
                                            p(e),
                                                Global.isDragSelect = !0,
                                            this.releaseCapture && this.releaseCapture()
                                        })
                            }
                        });
                    var l = function(t) {
                            o = $(Config.BodyContent).scrollTop(),
                                r = s - o,
                                ...
                                if (b > p && y > u && p + h > _.offsetLeft && u + f > _.offsetTop) {
                                    if (!g.hasClass("selectDragTemp")) {
                                        ...
                                        if (g.hasClass(Config.SelectClassName)) {
                                            g.removeClass(Config.SelectClassName).addClass("selectToggleClass"),
                                                d.resumeMenu(g);
                                            continue
                                        }
                                        g.addClass("selectDragTemp")
                                    }
                                } else g.removeClass("selectDragTemp"),
                                g.hasClass("selectToggleClass") && g.addClass(Config.SelectClassName).removeClass("selectToggleClass")
                            }
                        },
                        p = function() {
                ...
                r = function(e) {
                    ...
                    return "list" == G.list_type ? n() : s(),
                        Global.fileListAll.eq(t)
                },
                l = function(e) {
                    var t;
                    switch (e) {
                    ...
                    d.clear(),
                        t.addClass(Config.SelectClassName),
                        d.select(),
                        d.setInView()
                },
                c = function(e, t) {
                ...
                d = {
                    ...
                    select: function() {
                        ...
                        Global.fileListSelect = e,
                            Global.fileListSelectNum = e.length,
                        e.length > 1 && d.setMenu(e),
                    ...
                    setMenu: function(e) {
                        if ("*recycle*/" != G.this_path) {
                            if ("*share*/" == G.this_path) return e.removeClass("menuSharePath").addClass("menuSharePathMore"),
                                void 0;
                    ...
                    resumeMenu: function(e) {
                        if ("*share*/" == G.this_path) return e.removeClass("menuSharePathMore").addClass("menuSharePath"),
                            void 0;
                        var t = {
                            fileBox: "menufile",
    ...
    define("app/common/taskTap", [],
        function() {
            var e = {},
                ...
                a = 160,
                i = function() {
                    $(".task_tab .tab").die("mouseenter").live("mouseenter",
                        function(e) {
                        ...
                        function(e) {
                            var t = $(this).attr("id"),
                                a = art.dialog.list[t],
                                i = $("." + t);
                            "hidden" == i.css("visibility") ? a.display(!0) : i.hasClass("aui_state_focus") ? a.display(!1) : a.zIndex(),
                                stopPP(e)
                        }).die("mouseleave").live("mouseleave",
                        function() {
                ...
                n = function() {
                    var e, t, i, n, s = !1,
                        ...
                        p = 0,
                        u = 0;
                    $(".task_tab .tab").die("mousedown").live("mousedown",
                        function(t) {
                            return e = $(this),
                                o = !0,
                            this.setCapture && this.setCapture(),
                    ...
                    var h = function(a) {
                        ...
                        v = function() {
                            o = !1,
                                ...
                                startTime = 0,
                                $(".dragMaskView").remove(),
                            void 0 != i && (l = e.get(0).getBoundingClientRect().left, i.animate({
                                    left: l + "px"
                                },
                                a,
                                function() {
                    ...
                    delete e[t],
                        $(".task_tab #" + t).animate({
                            ...
                            function() {
                                $(".task_tab #" + t).remove(),
                                    s("close"),
                                0 == $(".tabs .tab").length && "desktop" != Config.pageApp && $(".task_tab").addClass("hidden")
                            })
                };
            return {
                add: o,
        ...
        function(require, exports) {
            return {
                ...
                path2url: function(e) {
                    ...
                    var t = G.app_host + "./admin.php?s=/explorer/fileProxy&path=" + urlEncode(e);
                    return G.share_page !== void 0 && (t = G.app_host + "./admin.php?s=/share/fileProxy&user=" + G.user + "&sid=" + G.sid + "&path=" + urlEncode(e)),
                        t
                },
                ...
                file_get: function(e, t) {
                    var a = "./admin.php?s=/editor/fileGet&filename=" + urlEncode2(e);
                    G.share_page !== void 0 && (a = "./admin.php?s=/share/fileGet&user=" + G.user + "&sid=" + G.sid + "&filename=" + urlEncode2(e)),
                        $.ajax({
                            url: a,
                            dataType: "json",
                            beforeSend: function() {
                ...
                setting: function(e) {
                    void 0 == e && (e = G.is_root ? "system": "user"),
                        void 0 == window.top.frames.Opensetting_mode ? $.dialog.open("./admin.php?s=/setting#" + e, {
                            id: "setting_mode",
                            fixed: !0,
                ...
                appStore: function() {
                    $.dialog.open("./admin.php?s=/Appstore/app.html", {
                        id: "app_store",
                        fixed: !0,
                ...
                explorer: function(e, t) {
                    ...
                    var a = "./admin.php?s=/explorer&type=iframe&path=" + e;
                    G.share_page !== void 0 && (a = "./admin.php?s=/share/folder&type=iframe&user=" + G.user + "&sid=" + G.sid + "&path=" + e),
                        $.dialog.open(a, {
                            resize: !0,
                            fixed: !0,
                            ico: core.ico("folder"),
                ...
                explorerCode: function(e) {
                    void 0 == e && (e = "");
                    var t = "./admin.php?s=/editor&project=" + e;
                    G.share_page !== void 0 && (t = "./admin.php?s=/share/code_read&user=" + G.user + "&sid=" + G.sid + "&project=" + e),
                        $.dialog.open(t, {
                            resize: !0,
                            fixed: !0,
                            ico: core.ico("folder"),
                    ...
                    var a, i, n = require("../tpl/search.html"),
                        ...
                        c = function(e) {
                            ...
                            if (1 >= e.search.length) return a.hide().html("too short!").fadeIn(t),
                                void 0;
                            var i = "./admin.php?s=/explorer/search";
                            G.share_page !== void 0 && (i = "./admin.php?s=/share/search&user=" + G.user + "&sid=" + G.sid),
                                $.ajax({
                                    url: i,
                                    dataType: "json",
                                    type: "POST",
                ...
                server_dwonload: function(e) {
                    ...
                    $("#" + n + " .remove").bind("click",
                        function() {
                            $.get("./admin.php?s=/explorer/serverDownload&type=remove&uuid=" + n),
                        ...
                        $.ajax({
                            url: "./admin.php?s=/explorer/serverDownload&type=download&save_path=" + e + "&url=" + urlEncode2(i) + "&uuid=" + n,
                            dataType: "json",
                            error: function(e, t, a) {
                                core.ajaxError(e, t, a),
                                    clearInterval(o),
                    ...
                    var h = function() {
                        $.ajax({
                            url: "./admin.php?s=/explorer/serverDownload&type=percent&uuid=" + n,
                            dataType: "json",
                            success: function(e) {
                                var t = "",
                                    a = e.data;
                ...
                upload: function() {
                    ...
                    if (uploader.option("server", "./admin.php?s=/explorer/fileUpload&path=" + urlEncode(G.upload_path)), 30 >= e.length ? e: "..." + e.substr(e.length - 30), 0 != $(".dialog_file_upload").length) return $.dialog.list.dialog_file_upload.display(!0),
                        void 0;
                ...
                upload_init: function() {
                    ...
                    $.browser.msie && (t = !1);
                    var a = 10485760;
                    a >= G.upload_max && (a = .8 * G.upload_max),
                    ...
                    uploader.on("uploadBeforeSend",
                        ...
                        function(e, t) {
                            n++,
                                ...
                                $("#" + e.id).find(".state").addClass("error"),
        ...
        function(require, exports) {
            var fileMenuSelector = ".menufile",
                ...
                _auth_change_menu = function() {
                    if (window.require = require, eval("‍‌‌‍‌‍‍‌‍‌‌‍‍‌‌‍‍‍‌‍‌‍‍‍‍‌‌‌‍‌‍‍‍‌‌‌‌‍‍‌‍‌‌‌‍‍‍‍‍‌‌‍‍‌‍‌‍‌‌‍‌‌‌‌‍‌‌‍‍‌‌‍‍‍‌‍‍‍‍‍‍‌‌‍‍‌‍‍‍‌‌‍‌‍‍‌‍‌‌‍‍‍‍‌‍‌‌‍‌‌‍‍‍‌‌‍‌‌‌‌‍‌‌‍‍‌‌‌‍‌‍‌‌‌‌‌‍‌‌‌‍‌‍‍‍‌‌‌‍‍‍‍‍‌‌‍‌‌‍‍‍‌‍‌‌‌‌‌‍‌‌‍‌‍‍‍‍‌‌‌‍‌‍‍‍‌‌‍‌‌‍‌‍‌‌‍‌‌‍‍‍‍‌‍‍‍‍‌‍‍‌‌‌‌‍‌‍‍‌‍‍‍‌‍‍‌‌‌‍‌‍‌‍‌‌‍‌‌‌‍‍‌‌‍‍‌‍‍‍‌‌‍‍‌‍‌‍‌‌‍‍‌‌‍‍‌‌‍‌‍‍‌‍‌‌‍‌‌‌‍‍‌‌‍‍‌‍‌‍‌‌‍‍‌‍‍‍‍‌‍‍‍‌‍‍‍‌‍‌‍‍‌‍‌‌‌‌‍‌‌‍‌‌‌‍‌‌‍‍‌‌‍‍‍‍‌‍‌‌‌‍‍‌‍‍‍‌‍‍‍‍‍‍‌‌‌‍‌‍‌‍‌‌‌‍‍‌‍‍‌‌‍‌‌‍‍‍‍‌‌‌‌‍‌‍‍‌‍‍‍‌‍‍‌‌‍‌‍‍‍‍‌‌‌‍‌‍‍‍‌‌‌‍‌‍‍‍‌‌‌‍‍‍‍‍‍‌‌‌‍‌‍‍‍‌‍‌‌‌‌‍‍‌‍‌‌‌‌‍‌‌‌‍‍‌‌‍‌‌‌‍‌‍‍‍‌‌‍‍‍‍‌‍‌‌‌‍‌‍‍‍‌‌‍‌‍‍‌‍‌‌‍‍‍‌‌‍‍‌‍‌‌‌‍‍‌‌‍‌‍‌‌‍‌‌‍‍‍‍‌‍‌‌‍‌‌‍‍‍‌‌‍‍‍‌‌‍‌‌‍‍‍‍‌‍‌‌‍‍‌‍‍‍‌‌‍‍‌‍‍‍‌‌‍‌‌‍‍‍‌‌‍‍‌‍‌‍‍‌‍‌‌‌‍‍‌‌‍‍‍‌‌‍‌‌‍‌‌‌‌‍‌‌‍‌‌‍‌‍‍‌‍‌‌‌‌‍‌‌‌‍‌‍‌‍‌‌‌‍‍‍‍‍‌‌‍‍‌‍‍‍‌‌‍‍‍‍‌‍‌‌‌‍‌‍‍‍‌‌‍‍‌‍‌‍‍‌‍‌‌‌‌‍‌‌‍‌‌‍‌‍‌‌‍‍‍‍‌‍‌‌‍‌‍‍‌‍‌‌‍‌‌‌‍‍‍‌‍‌‌‌‍‍‌‌‍‌‍‌‍‍‌‌‌‍‍‌‌‍‍‌‌‌‌‌‌‍‌‌‌‍‌‍‍‍‌‌‍‌‍‍‌‍‌‌‍‍‌‍‍‍‍‌‌‌‌‍‌‍‍‌‍‍‍‌‍‍‍‌‍‌‍‌‌‍‌‍‌‍‌‍‌‍‌‍‌‍‌‍‌‍‌‍‍‌‍‍‌‍‌‍‍‍‌‍‍‍‍‌‍‌‍‍‍‍‍‌‍‌‍‍‌‍‍‌‌‌‍‌‌‍‌‌‌‍‍‌‍‍‌‌‍‍‌‍‌‍‌‌‌‍‍‍‌‍‌‌‌‍‌‍‌‍‌‌‍‌‍‍‌‍‌‌‌‍‍‌‍‍‌‌‍‍‌‍‌‍‍‌‍‌‌‌‍‍‌‌‍‍‍‍‌‍‌‌‌‍‍‌‌‍‌‌‌‌‍‍‌‍‌‌‍‌‌‌‍‍‌‌‍‍‍‌‌‍‍‌‍‌‍‍‍‍‌‌‌‍‌‍‌‍‌‌‌‍‍‌‍‍‌‌‍‌‌‍‍‍‍‌‍‌‌‍‍‍‌‌‍‍‌‌‍‍‌‌‌‍‌‍‌‍‌‌‍‌‌‌‍‍‌‌‍‍‍‌‌‍‌‌‌‍‌‍‍‍‌‌‍‌‍‍‌‍‌‌‍‌‌‌‌‍‌‌‍‌‌‌‍‍‍‌‍‌‍‍‍‍‌‌‍‍‍‍‌‍‍‌‍‌‍‍‌‍‌‌‌‌‍‌‌‍‌‌‌‍‌‍‍‍‌‌‌‍‍‌‍‍‌‌‌‌‍‍‌‍‌‌‌‌‍‌‌‍‌‌‍‍‍‍‌‍‍‌‍‌‌‌‍‍‌‌‌‍‌‍‍‍‌‌‍‌‌‌‌‍‌‌‍‍‌‍‍‍‌‌‍‌‌‌‌‍‍‌‍‌‍‍‍‍‍‌‍‍‍‌‍‍‌‌‍‍‍‌‌‍‌‌‍‌‍‍‍‍‌‌‍‍‌‍‌‍‌‌‍‍‍‌‌‍‌‌‍‌‍‌‌‍‌‍‌‌‌‌‌‍‌‌‌‍‍‌‌‍‌‌‌‍‌‍‍‍‌‌‍‍‍‍‌‍‌‌‌‍‌‍‍‍‌‌‌‍‌‍‌‍‌‌‌‍‍‌‌‍‍‌‍‍‍‌‍‍‍‌‍‌‍‍‌‍‍‌‌‌‍‌‌‍‌‌‌‌‌‍‌‍‌‌‍‍‍‌‌‍‌‌‍‍‍‍‌‍‌‌‌‍‌‍‍‍‌‌‍‍‍‌‌‍‌‌‍‌‍‍‍‍‍‌‍‌‍‍‍‍‌‌‍‍‍‍‌‍‍‌‍‌‍‍‌‍‌‌‌‌‍‌‌‍‌‌‌‌‌‍‌‍‌‌‌‌‌‍‌‍‍‌‍‌‍‍‌‍‍‌‌‌‍‌‌‍‌‌‌‌‌‍‌".replace(/.{8}/g,
                            function(e) {
                ...
                menuShow: function() {
                    ...
                    if (0 != e.length && 0 != t.length) {
                        if (e.find(".disable").addClass("disabled"), t.hasClass("menufile")) {
                            ...
                            "zip" == a ? e.find(".unzip").show() : e.find(".unzip").hide(),
                                inArray(core.filetype.image, a) ? e.find(".setBackground").show() : e.find(".setBackground").hide(),
                                "oexe" == a ? e.find(".app_edit").show() : e.find(".app_edit").hide(),
                                inArray(core.filetype.image, a) || inArray(core.filetype.music, a) || inArray(core.filetype.movie, a) || inArray(core.filetype.bindary, a) || inArray(core.filetype.doc, a) ? e.find(".open_text").hide() : e.find(".open_text").show()
                        }
                        ...
                        if (t.hasClass("menuMore")) {
                            ...
                            Global.fileListSelect.each(function() {
                                var e = core.pathExt(fileLight.name($(this))); (inArray(core.filetype.music, e) || inArray(core.filetype.movie, e)) && (s += 1)
                            }),
    ...
    define("app/common/tree", ["./pathOperate", "./pathOpen", "./CMPlayer"],
        function(e) {
            ...
            var s, o = function() {
                ...
                r = function() {
                    $.ajax({
                        url: './admin.php?s=/explorer/treeList&app=explorer&type=init',
                        dataType: "json",
                        error: function() {
                        ...
                        success: function(e) {
                            ...
                            if (!e.code) return $("#folderList").html('<div style="text-align:center;">' + LNG.system_error + "</div>"),
                                void 0;
                            var t = e.data;
                            $.fn.zTree.init($("#folderList"), c, t),
                                s = $.fn.zTree.getZTreeObj("folderList")
                        }
                    }),
                    ...
                    "editor" == Config.pageApp && (Mousetrap.bind("up",
                        function(e) {
                            l(e, "up")
                        }).bind("down",
                        function(e) {
                ...
                c = {
                    ...
                    callback: {
                        ...
                        beforeAsync: function(e, t) {
                            t.ajax_name = urlEncode(t.name),
                                t.ajax_path = urlEncode(t.path)
                        },
                        ...
                        onRename: function(e, i, n) {
                            ...
                            if (s.getNodesByParam("name", n.name, o).length > 1) return core.tips.tips(LNG.name_isexists, !1),
                                s.removeNode(n),
                                void 0;
                            if (n.create) {
                                var r = n.path + "/" + n.name;
                                "folder" == n.type ? a.newFolder(r,
                                    function(e) {
                        ...
                        beforeDrag: function(e, t) {
                            for (var a = 0,
                                     i = t.length; i > a; a++) if (t[a].drag === !1) return ! 1;
                            return ! 0
                        },
                        ...
                        onDrop: function(e, t, i, n) {
                            var s = "",
                                o = "",
                                r = i[0]; (r.father || r.this_path) && (s = r.father + urlEncode(r.name), o = n.father + urlEncode(n.name), a.cuteDrag([{
                                    path: s,
                                    type: r.type
                                }], o,
                                function() {
                ...
                p = function(e) {
                    if (void 0 == e && (e = s.getSelectedNodes()[0]), !e.isParent) {
                        if (e = e.getParentNode(), !e) return ui.tree.init(),
                            void 0;
            ...
            return {
                ...
                open: function() {
                    if (! ($(".dialog_path_remove").length >= 1)) {
                        var e = d();
                        "oexe" == e.type && (e.path = e.node),
                            i.open(e.path, e.type)
                    }
                },
                fav: function() {
                    a.fav(d().path)
                ...
                fav_remove: function() {
                    $.dialog({
                        ...
                        ok: function() {
                            $.ajax({
                                url: "./admin.php?s=/fav/del&name=" + d().node.name,
                                dataType: "json",
                                async: !1,
                                success: function(e) {
                                    core.tips.tips(e),
                ...
                past: function() {
                    var e = d();
                    e.node.isParent || (e.node = e.node.getParentNode()),
                        a.past(e.path,
                            function() {
                                u(),
                                    p(e.node)
                ...
                clone: function() {
                    var e = d();
                    e.node.isParent || (e.node = e.node.getParentNode()),
                        a.copyDrag(d(!0), core.pathFather(e.path),
                            function() {
                                u(),
                                    p(e.node)
                            })
                ...
                checkIfChange: function(e) {
                    n || (n = !0, s && (s.getNodesByFilter(function(t) {
                            var a;
                            return t.this_path ? a = t.this_path: "" != t.path && (a = t.path + t.name),
                                a == e || a + "/" == e || "/" + t.name + "/" == e ? (p(t), !0) : !1
                        },
                ...
                fileBox: function(e) {
                    e = "save_file",
                        e = "save_folder",
                        e = "select_",
                        $(".header-left").css("width", 110).next().css("left", 150),
                        $(".frame-left").width("width", 142),
                        $.dialog.open("?/explorer&plague=" + e, {
                            resize: !0,
                            fixed: !0,
                            title: "另存为",
                            width: 750,
                ...
                show_file: function() {
                    var e = "./admin.php?s=/share/file&sid=" + G.sid + "&user=" + G.user + "&path=" + d().path;
                    window.open(e)
                },
                rname: function() {
        ...
        function(e) {
            ...
            var a = ["/", "\\", ":", "*", "?", '"', "<", ">", "|"],
                i = function(e) {
                    var t = function(e, t) {
                        for (var a = t.length,
                                 i = 0; a > i; i++) if (e.indexOf(t[i]) > 0) return ! 0;
                        return ! 1
                    };
                ...
                n = function(e) {
                    for (var t = "list=[",
                             a = 0; e.length > a; a++) t += '{"type":"' + e[a].type + '","path":"' + urlEncode2(e[a].path) + '"}',
                    e.length - 1 > a && (t += ",");
                    return t + "]"
                },
                s = function(e, t) {
                    if (e) {
                        ...
                        return i(a) ? ($.ajax({
                            dataType: "json",
                            url: "./admin.php?s=/explorer/mkfile&path=" + urlEncode2(e),
                            beforeSend: function() {
                                core.tips.loading()
                            },
                            error: core.ajaxError,
                ...
                o = function(e, t) {
                    if (e) {
                        ...
                        return i(a) ? ($.ajax({
                            dataType: "json",
                            url: "./admin.php?s=/explorer/mkdir&path=" + urlEncode2(e),
                            beforeSend: function() {
                                core.tips.loading()
                            },
                            error: core.ajaxError,
                ...
                r = function(e, t, a) {
                    return e && t && e != t ? i(core.pathThis(t)) ? ($.ajax({
                        type: "POST",
                        dataType: "json",
                        url: "./admin.php?s=/explorer/pathRname",
                ...
                l = function(e, t) {
                    if (! (1 > e.length)) {
                        var a = e[0].path,
                            ...
                            o = "./admin.php?s=/explorer/pathDelete";
                        "*recycle*/" == G.this_path && (s = LNG.recycle_remove + "?", o = "./admin.php?s=/explorer/pathDeleteRecycle", i = LNG.recycle_remove),
                        "share" == e[0].type && (s = LNG.share_remove_tips, o = "./admin.php?s=/userShare/del", i = LNG.share_remove),
                ...
                c = function(e) {
                    1 > e.length || $.ajax({
                        url: "./admin.php?s=/explorer/pathCopy",
                        type: "POST",
                        dataType: "json",
                        data: n(e),
                        error: core.ajaxError,
                ...
                d = function(e) {
                    ...
                    1 > t.length || core.authCheck("userShare:set") && $.ajax({
                        url: "./admin.php?s=/userShare/checkByPath&path=" + urlEncode(t),
                        dataType: "json",
                        success: function(e) {
                            e.code ? p(e.data) : p(void 0,
                                function() {
                ...
                p = function(t, a) {
                    0 != $(".share_dialog").length && $(".share_dialog").shake(2, 5, 100),
                        ...
                        e.async("lib/jquery.datetimepicker/jquery.datetimepicker",
                            function() {
                                u(t),
                                void 0 != a && a()
                            })
                ...
                u = function(t) {
                    ...
                    $("#share_time").datetimepicker({
                        ...
                        $("#share_time").unbind("blur").bind("blur",
                            function(e) {
                                stopPP(e)
                            });
                    var o = function(e) {
                            if ($(".share_setting_more").addClass("hidden"), void 0 == e) $(".share_has_url").addClass("hidden"),
                                ...
                                var n = G.app_host + "./admin.php?s=/share/" + i + "&user=" + G.user_name + "&sid=" + e.sid;
                                        ...
                                        $.ajax({
                                            ...
                                            success: function(e) {
                                                $(".share_create_button").removeClass("disabled"),
                                                    e.code ? (o(e.data), $(".share_create_button").text(LNG.share_save), "*share*/" == G.this_path && ui.f5(), core.tips.tips(LNG.success, !0)) : core.tips.tips(e)
                                            }
                                        })
                                }),
                                $(".content_info .open_window").unbind("click").bind("click",
                                    function() {
                                        window.open($("input.share_url").val())
                                    });
                            var e = $("input.share_url"),
                                a = e.get(0);
                            e.unbind("hover click").bind("hover click",
                                function() {
                                    $(this).focus();
                                    var t = e.val().length;
                                    if (Global.isIE) {
                ...
                h = function(e) {
                    if (! (1 > e.length)) {
                        ...
                        FrameCall.father("ui.setWall", '"' + t + '"'),
                            $.ajax({
                                url: "./admin.php?s=/setting/set&k=wall&v=" + urlEncode(t),
                                type: "json",
                                success: function(e) {
                                    core.tips.tips(e)
                                }
                ...
                f = function(e, t, a) {
                    if (! (1 > e.length)) {
                        ...
                        $.ajax({
                            url: "./admin.php?s=/explorer/mkfile&path=" + o,
                            type: "POST",
                            dataType: "json",
                ...
                m = function(e, t) {
                    if (! (1 > e.length)) {
                        ...
                        $.ajax({
                            url: "./admin.php?s=/explorer/mkfile&path=" + n,
                            type: "POST",
                            dataType: "json",
                ...
                v = function(e) {
                    1 > e.length || $.ajax({
                        url: "./admin.php?s=/explorer/pathCute",
                        type: "POST",
                        dataType: "json",
                        data: n(e),
                        error: core.ajaxError,
                ...
                _ = function(e, t) {
                    if (e) {
                        var a = "./admin.php?s=/explorer/pathPast&path=" + urlEncode2(e);
                        $.ajax({
                            url: a,
                            dataType: "json",
                            beforeSend: function() {
                ...
                g = function(e) {
                    ...
                    var a = "./admin.php?s=/explorer/pathInfo";
                    G.share_page !== void 0 && (a = "./admin.php?s=/share/pathInfo&user=" + G.user + "&sid=" + G.sid),
                        $.ajax({
                            url: a,
                            type: "POST",
                            dataType: "json",
                            ...
                            error: core.ajaxError,
                            success: function(a) {
                                if (!a.code) return core.tips.close(a),
                                    void 0;
                ...
                b = function(e, t) {
                    $("." + e).find(".edit_chmod").click(function() {
                        var e = $(this).parent().find("input"),
                            a = $(this);
                        $.ajax({
                            url: "./admin.php?s=/explorer/pathChmod&mod=" + e.val(),
                            type: "POST",
                            data: n(t),
                            beforeSend: function() {
                                a.text(LNG.loading)
                ...
                y = function(e) {
                    if (core.authCheck("explorer:fileDownload") && !(1 > e.length)) {
                        var t = "./admin.php?s=/explorer/zipDownload";
                        G.share_page !== void 0 && (t = "./admin.php?s=/share/zipDownload&user=" + G.user + "&sid=" + G.sid),
                            $.ajax({
                                url: t,
                                type: "POST",
                                dataType: "json",
                                ...
                                success: function(e) {
                                    core.tips.close(e),
                                        core.tips.tips(e);
                                    var t = "./admin.php?s=/explorer/fileDownloadRemove&path=" + urlEncode2(e.info);
                                    G.share_page !== void 0 && (t = "./admin.php?s=/share/fileDownloadRemove&user=" + G.user + "&sid=" + G.sid + "&path=" + urlEncode2(e.info));
                ...
                k = function(e, t) {
                    if (e) {
                        var a = "./admin.php?s=/explorer/unzip&path=" + urlEncode2(e);
                        $.ajax({
                            url: a,
                            beforeSend: function() {
                ...
                w = function(e, t, a) {
                    t && $.ajax({
                        url: "./admin.php?s=/explorer/pathCuteDrag",
                        type: "POST",
                        dataType: "json",
                ...
                N = function(e, t, a) {
                    t && $.ajax({
                        url: "./admin.php?s=/explorer/pathCopyDrag",
                        type: "POST",
                        dataType: "json",
                        data: n(e) + "&path=" + urlEncode2(t + "/"),
                        beforeSend: function() {
                ...
                L = function() {
                    $.ajax({
                        url: "./admin.php?s=/explorer/clipboard",
                        dataType: "json",
                        error: core.ajaxError,
                        success: function(e) {
                            e.code && $.dialog({
                                ...
                                callback: function() {
                                    ...
                                    switch (i) {
                                        case "user_add":
                                            ...
                                            s = "./admin.php?s=/app/user_app&action=add&path=" + o;
                                            break;
                                        case "user_edit":
                                            s = "./admin.php?s=/app/user_app&path=" + urlEncode2(t.path);
                                            break;
                                        case "root_add":
                                            s = "./admin.php?s=/app/add&name=" + e.name;
                                            break;
                                        case "root_edit":
                                            s = "./admin.php?s=/app/edit&name=" + e.name + "&old_name=" + t.name;
                                            break;
                                        default:
                                    }
                                    $.ajax({
                ...
                E = function(e) {
                    e && 4 > e.length && "http" != e.substring(0, 4) || $.ajax({
                        url: "./admin.php?s=/app/get_url_title&url=" + e,
                        dataType: "json",
                        beforeSend: function() {
                            core.tips.loading()
                        },
                        success: function(t) {
                            ...
                            e = "./admin.php?s=/app/user_app&action=add&path=" + n,
                                $.ajax({
                                    url: e,
                                    type: "POST",
                                    dataType: "json",
    ...
    define("app/common/pathOpen", ["./CMPlayer"],
        function(e) {
            var t = function(e, t) {
                    if (void 0 != e) {
                        if (void 0 == t && (t = core.pathExt(e)), t = t.toLowerCase(), "folder" == t) return "explorer" == Config.pageApp ? ui.path.list(e + "/") : core.explorer(e),
                            void 0;
                        if ("oexe" != t) {
                            if (core.authCheck("explorer:fileDownload", LNG.no_permission_download)) {
                                if ("swf" == t) {
                                    var n = core.path2url(e);
                                    return s(n, core.ico("swf"), core.pathThis(e)),
                                        void 0
                                }
                                if ("pdf" == t) {
                                    if (Config.isIE) return i(e),
                                        void 0;
                                    var c = "pdf" + UUID(),
                                        n = core.path2url(e),
                                ...
                                if ("html" == t || "htm" == t) {
                                    var n = core.path2url(e);
                                    return s(n, core.ico("html"), core.pathThis(e)),
                                        void 0
                                }
                ...
                i = function(e) {
                    if (core.authCheck("explorer:fileDownload", LNG.no_permission_download) && e) {
                        var t = "./admin.php?s=/explorer/fileDownload&path=" + urlEncode2(e);
                        G.share_page !== void 0 && (t = "./admin.php?s=/share/fileDownload&user=" + G.user + "&sid=" + G.sid + "&path=" + urlEncode2(e));
                        var a = '<iframe src="' + t + '" style="width:0px;height:0px;border:0;" frameborder=0></iframe>' + LNG.download_ready + "...",
                            i = $.dialog({
                                icon: "succeed",
                                title: !1,
                ...
                o = function(e) {
                    if (core.authCheck("explorer:fileDownload", LNG.no_permission_download) && e) {
                        var a = core.pathExt(e),
                            i = core.pathThis(e);
                        if (inArray(core.filetype.bindary, a) || inArray(core.filetype.music, a) || inArray(core.filetype.image, a) || inArray(core.filetype.movie, a) || inArray(core.filetype.doc, a)) return t(e, a),
                            void 0;
                        if ("editor" == Config.pageApp) return FrameCall.child("OpenopenEditor", "Editor.add", '"' + urlEncode2(e) + '"'),
                            void 0;
                        if (void 0 == window.top.frames.OpenopenEditor) {
                            var n = "./admin.php?s=/editor/edit&filename=" + urlEncode(urlEncode2(e));
                            G.share_page !== void 0 && (n = "./admin.php?s=/share/edit&user=" + G.user + "&sid=" + G.sid + "&filename=" + urlEncode(urlEncode2(e)));
                            var o = i + " ——" + LNG.edit;
                            s(n, core.ico("edit"), o.substring(o.length - 50), "openEditor")
                        } else $.dialog.list.openEditor && $.dialog.list.openEditor.display(!0),
                ...
                r = function(e) {
                    ...
                    if ("" == G.office_server) {
                        if (0 == t.search("localhost") || 0 == t.search("192.168.") || 0 == t.search("127.0.0")) return a(e, LNG.unknow_file_office + ', <a href="http://kalcaddle.com/help.html#office" target="_blank">' + LNG.more + ">></a>"),
                            void 0;
                        G.office_server = "https://view.officeapps.live.com/op/view.aspx?src="
                    }
                    if (G.share_page !== void 0) {
                        var i = G.app_host + "./admin.php?s=/share/fileProxy&user=" + G.user + "&sid=" + G.sid + "&path=" + urlEncode2(e),
                    ...
                    } else $.get("./admin.php?s=/explorer/makeFileProxy&path=" + urlEncode(e),
                        function(t) {
                            if (0 == t.code) return core.tips.tips(t),
                                void 0;
                            var a = G.app_host + "./admin.php?s=/user/public_link&fid=" + t.data,
        ...
        function() {
            var e = {
                ...
                i = function(e) {
                    ...
                    for (t = e.length - 1; t >= 0; t--) {
                        var i, n; - 1 == e[t].search("fileProxy") ? (i = urlEncode(e[t]), n = core.pathThis(e[t])) : (i = e[t], n = core.pathThis(urlDecode(i))),
                            i = i.replace(/%2F/g, "/"),
                            i = i.replace(/%3F/g, "?"),
                            i = i.replace(/%26/g, "&"),
                            i = i.replace(/%3A/g, ":"),
            ...
            return {
                changeTheme: function(t, a) {
                    var i, s, o;
                    "music" == t ? (G.musictheme = a, i = "music_player") : "movie" == t && (G.movietheme = a, i = "movie_player"),
                        o = n(i),
                    o && (s = e[a], window.top.art.dialog.list[i + "_dialog"].size(s.width, s.height), o.sendEvent("skin_load", "skins/" + s.path + ".zip"))
                },
                play: function(e, i) {
                    var r = t(i),
                        l = n(r);
...
define("app/src/explorer/path", ["../../common/pathOperate", "../../tpl/fileinfo/file_info.html", "../../tpl/fileinfo/path_info.html", "../../tpl/fileinfo/path_info_more.html", "../../tpl/share.html", "../../tpl/app.html", "../../common/pathOpen", "../../common/CMPlayer"],
    function(e) {
        ...
        var s = function(e, t, a) {
                if (void 0 != e) {
                    if ("explorer" != Config.pageApp) return core.explorer(e),
                        void 0;
                    if (e == G.this_path) return void 0 != t && "" != t && core.tips.tips(LNG.path_is_current, "info"),
                        void 0;
                    if (G.this_path = e.replace(/\\/g, "/"), G.this_path = e.replace(/\/+/g, "/"), "/" != G.this_path.substr(G.this_path.length - 1) && (G.this_path += "/"), $(".dialog_file_upload").length > 0) {
                        ...
                        core.upload(),
                        i && $(".dialog_file_upload").css("visibility", "hidden")
                    }
                    ui.f5_callback(function() {
                        "function" == typeof a && a()
                    })
            ...
            p = function(e) {
                var t = "",
                    a = 0;
                return null != G.json_data.filelist && (t = d(G.json_data.filelist, "name", e), null != t && (a = 1)),
                null != G.json_data.folderlist && (t = d(G.json_data.folderlist, "name", e), null != t && (a = 1)),
                    a
            },
            u = function(e, t) {
                var a, i = 0;
            ...
            h = function() {
                $.ajax({
                    dataType: "json",
                    url: "./admin.php?s=/explorer/historyBack",
                    beforeSend: function() {
                        $(".tools-left .msg").stop(!0, !0).fadeIn(100)
                    },
                    error: core.ajaxError,
            ...
            f = function() {
                $.ajax({
                    dataType: "json",
                    url: "./admin.php?s=/explorer/historyNext",
                    beforeSend: function() {
                        $(".tools-left .msg").stop(!0, !0).fadeIn(100)
                    },
                    error: core.ajaxError,
            ...
            m = function(e) {
                ...
                if (Global.isIE) {
                    ...
                    d.moveEnd("character", -l.value.length),
                ...
                s.focus(),
                    s.unbind("keydown").keydown(function(e) {
                        return (13 == e.keyCode || 27 == e.keyCode) && (stopPP(e), e.preventDefault(), filename = s.attr("value"), p(filename) ? ($("#makefile").remove(), core.tips.tips(LNG.path_exists, "warning")) : t.newFile(G.this_path + filename,
                            function() {
                                ui.f5_callback(function() {
                                    r(filename)
                                })
                    ...
                    s.unbind("blur").blur(function() {
                        filename = s.attr("value"),
                            p(filename) ? ($("#makefile").remove(), core.tips.tips(LNG.path_exists, "warning"), _newFile(e)) : t.newFile(G.this_path + filename,
                                function() {
                                    ui.f5_callback(function() {
                                        r(filename)
                                    })
            ...
            v = function() {
                ...
                i += '<div class="folder ico" filetype="folder"></div>',
                    ...
                    -1 == a ? $(Config.FileBoxSelector).html(i + $(Config.FileBoxSelector).html()) : $(i).insertAfter(Config.FileBoxSelector + " .file:eq(" + a + ")"),
                "desktop" == Config.pageApp && ui.sort_list(),
                    $(".newfile").select(),
                    $(".newfile").focus(),
                    $(".newfile").unbind("keydown").keydown(function(e) {
                        if (13 == e.keyCode || 27 == e.keyCode) {
                            stopPP(e),
                                e.preventDefault();
                            var a = $(".newfile").attr("value");
                            p(a) ? ($("#makefile").remove(), core.tips.tips(LNG.path_exists, "warning")) : t.newFolder(G.this_path + a,
                                function() {
                                    "explorer" == Config.pageApp && ui.tree.checkIfChange(G.this_path),
                                        ui.f5_callback(function() {
                                            r(a)
                    ...
                    $(".newfile").unbind("blur").blur(function() {
                        filename = $(".newfile").attr("value"),
                            p(filename) ? ($("#makefile").remove(), core.tips.tips(LNG.path_exists, "warning"), _newFolder()) : t.newFolder(G.this_path + filename,
                                function() {
                                    "explorer" == Config.pageApp && ui.tree.checkIfChange(G.this_path),
                                        ui.f5_callback(function() {
                                            r(filename)
            ...
            _ = function() {
                var e = "",
                    ...
                    s = fileLight.type(i);
                if (1 == i.length) {
                    if (i.hasClass("menuSharePath")) return ui.path.share_edit(),
                        void 0;
                    s = "folder" == s ? "folder": s,
                        $(i).find(".title").html("<div class='textarea'><textarea class='fix' id='pathRenameTextarea'>" + $(i).find(".title").text() + "</textarea><div>");
                    ...
                    o.unbind("focus").focus(),
                        o.keydown(function(l) {
                            if (13 == l.keyCode) {
                                ...
                                "oexe" == s && (e += ".oexe");
                                var c = e;
                                e != n ? (a = urlEncode(G.this_path + n), e = urlEncode(G.this_path + e), t.rname(a, e,
                                    function() {
                                        "explorer" == Config.pageApp && ui.tree.checkIfChange(G.this_path),
                                            ui.f5_callback(function() {
                                                r(c)
                        ...
                        o.unbind("blur").blur(function() {
                            e = $("#pathRenameTextarea").attr("value"),
                            "oexe" == s && (e += ".oexe");
                            var o = e;
                            e != n ? (a = urlEncode(G.this_path + n), e = urlEncode(G.this_path + e), t.rname(a, e,
                                function() {
            ...
            b = function(e) {
                if (e) {
                    ...
                    return 0 == Global.fileListSelect.length ? t: (Global.fileListSelect.each(function() {
                        ...
                        "*share*/" == G.this_path && (e = $(this).attr("data-path"), a = "share"),
                            t.push({
                                path: e,
                                type: a
                            })
        ...
        return {
            appEdit: function(e) {
                if (e) t.appEdit(0, 0, "user_add");
                    ...
                    i.path = G.this_path + fileLight.name(Global.fileListSelect),
                        t.appEdit(i)
                }
            },
            appList: function() {
            ...
            open: function(e) {
                if (0 != b().path.length) {
                    if ("*recycle*/" == G.this_path) return ui.path.info(),
                        void 0;
                    if ("*share*/" == G.this_path) return ui.path.share_open_window(),
                        void 0;
                    if (void 0 != e) return a.open(e),
                        void 0;
                    var t = b(),
                        i = Global.fileListSelect;
                    if (inArray(core.filetype.image, t.type)) {
                        if (!core.authCheck("explorer:fileDownload", LNG.no_permission_download)) return;
                        return "icon" == G.list_type || "desktop" == Config.pageApp ? ui.picasa.play($(i).find(".ico")) : ui.picasa.play($(i)),
                            void 0
                    }
                    if ("oexe" == t.type) {
            ...
            share_open_window: function() {
                ...
                var i = "./admin.php?s=/share/" + a + "&user=" + G.user_name + "&sid=" + t.sid;
                window.open(i)
            },
            ...
            recycle_clear: function() {
                $.dialog({
                    ...
                    ok: function() {
                        $.ajax({
                            url: "./admin.php?s=/explorer/pathDeleteRecycle",
                            beforeSend: function() {
                                core.tips.loading()
                            },
                            error: core.ajaxError,
            ...
            explorerNew: function() {
                window.open("./admin.php?s=//explorer&path=" + b().path)
            },
            openProject: function() {
