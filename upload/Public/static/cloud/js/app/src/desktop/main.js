...
function() {
	...
	i = function() {
		...
		function(e) {
			...
			t = art.dialog.list[a],
			i = $("." + a);
			"hidden" == i.css("visibility") ? t.display(!0) : i.hasClass("aui_state_focus") ? t.display(!1) : t.zIndex(),
			stopPP(e)
...
function(require, exports) {
	return {
		...
		path2url: function(e) {
			...
			var a = "./admin.php?s=/explorer/fileProxy&path=" + urlEncode(e);
			return G.share_page !== void 0 && (a = G.app_host + "./admin.php?s=/share/fileProxy&user=" + G.user + "&sid=" + G.sid + "&path=" + urlEncode(e)),
			a
		},
		...
		//清除缓存
		cleanup: function(e, a) {
			var cleanup_url = "./admin.php?s=/CleanUp/index.html";
			$.ajax({
				url: cleanup_url,
				dataType: "json",
				beforeSend: function() {
				...
				success: function(e) {
					core.tips.close(e.info);
				}
			})
		},
		//退出登录
		logout: function(e, a) {
			var logout_url = "./admin.php?s=/Public/logout.html";
			$.ajax({
				url: logout_url,
				dataType: "json",
				beforeSend: function() {
		...
		file_get: function(e, a) {
			var t = "./admin.php?s=/editor/fileGet&filename=" + urlEncode2(e);
			G.share_page !== void 0 && (t = "./admin.php?s=/share/fileGet&user=" + G.user + "&sid=" + G.sid + "&filename=" + urlEncode2(e)),
			$.ajax({
				url: t,
				dataType: "json",
				beforeSend: function() {
		...
		setting: function(e) {
			void 0 == window.top.frames.Opensetting_mode ? $.dialog.open("./admin.php?s=/Config/group.html", {
				id: "setting_mode",
				fixed: !0,
		...
		database: function(e) {
			void 0 == window.top.frames.Opensetting_mode ? $.dialog.open("./Addons/Plugins/sqlbuddy/", {
				id: "setting_mode",
				fixed: !0,
				ico: core.ico("setting"),
				resize: !0,
		...
		usercenter: function() {
			$.dialog.open("./admin.php?s=/User/updatepassword.html", {
				id: "usercenter",
				fixed: !0,
				ico: core.ico("usercenter"),
				resize: !0,
				title: '用户中心',
				width: 960,
				height: 550
		...
		explorer: function(e, a) {
			...
			var t = "./admin.php?s=/explorer/index&type=iframe&path=" + e;
			G.share_page !== void 0 && (t = "./admin.php?s=/share/folder&type=iframe&user=" + G.user + "&sid=" + G.sid + "&path=" + e),
			$.dialog.open(t, {
				resize: !0,
				fixed: !0,
				ico: core.ico("folder"),
		...
		explorerCode: function(e) {
			void 0 == e && (e = "");
			var a = "./admin.php?s=/editor&project=" + e;
			G.share_page !== void 0 && (a = "./admin.php?s=/share/code_read&user=" + G.user + "&sid=" + G.sid + "&project=" + e),
			$.dialog.open(a, {
				resize: !0,
				fixed: !0,
				ico: core.ico("folder"),
		...
		search: function(e, a) {
			...
			c = function(e) {
				...
				void 0;
				var i = "./admin.php?s=/explorer/search.html";
		...
		upload_init: function() {
			...
			$.browser.msie && (a = !1);
			var t = 10485760;
			t >= G.upload_max && (t = .8 * G.upload_max),
...
function(require, exports) {
	...
	_auth_change_menu = function() {
		$(Config.FileBoxClass).unbind("dblclick").live("dblclick",
		function(e) {
			stopPP(e),
			e.altKey ? ui.path.pathInfo() : ui.path.open()
		}),
		$(Config.FileBoxTittleClass).unbind("dblclick").live("dblclick",
		function(e) {
	...
	s = function() {
		...
		u = 0,
		h = 0;
		$(Config.FileBoxClass).unbind("mousedown").live("mousedown",
		function(a) {
		...
		m = function(e) {
			...
			Global.isIE && $("." + Config.TypeFolderClass + ",div.menuRecycleButton").each(function() {
				var a = e.pageX,
				t = e.pageY,
				i = $(this).offset(),
				n = $(this).width(),
		...
		v = function(e) {
			...
			i || (t += d.name($(".selectDragTemp"))),
			Global.ctrlKey ? (Math.abs(e.pageX - h) > r || Math.abs(e.pageY - u) > r) && ui.path.copyDrag(t, i) : i || ($(".selectDragTemp").hasClass("menuRecycleButton") ? ui.path.remove() : ui.path.cuteDrag(t))
		},
		_ = function() {
			p = !0,
	...
	o = function() {
		...
		i = null,
		n = null;
		$(Config.BodyContent).unbind("mousedown").live("mousedown",
		function(e) {
				...
				if (v > r && _ > l && r + c > f.offsetLeft && l + p > f.offsetTop) {
					if (!m.hasClass("selectDragTemp")) {
						...
						if (m.hasClass(Config.SelectClassName)) {
							m.removeClass(Config.SelectClassName).addClass("selectToggleClass"),
							d.resumeMenu(m);
							continue
						}
						m.addClass("selectDragTemp")
					}
				} else m.removeClass("selectDragTemp"),
				m.hasClass("selectToggleClass") && m.addClass(Config.SelectClassName).removeClass("selectToggleClass")
			}
		},
		r = function() {
...
function() {
	...
	n = function() {
		...
		$(document).keydown(function(a) {
			...
			return t && (stopPP(a), a.keyCode = 0, a.returnValue = !1),
			!0
		}).keyup(function(a) {
			a.shiftKey && (Global.shiftKey = !1),
			a.keyCode != e && a.ctrlKey || (Global.ctrlKey = !1)
		})
	},
	s = function() {
		var e = 10,
	...
	this._getFolderBox = function(e) {
		...
		a += "<div id='" + e.name + "' class='titleBox'><span class='title' title='" + LNG.double_click_rename + "'>" + e.name + "</span></div></div>"
	},
	this._getFileBox = function(e) {
		...
		if ("oexe" == e.ext && void 0 != e.icon) {
			...
			a = "<div class='file fileBox menufile' data-app=" + i + _hover_title(e) + ">",
			"app_link" == e.type ? (a += 0 == e.content.search("ui.path.open") ? "<div class='" + core.pathExt(n) + " ico'": "<div class='folder ico'", a += ' filetype="oexe"></div><div class="app_link"></div>') : a += "<div class='ico' filetype='oexe' style='background-image:url(" + t + ")'></div>",
			a += "<div id='' class='titleBox'><span class='title' title='" + LNG.double_click_rename + "'>" + n + "</span></div></div>"
			...
			a += "<div picasa='" + s + "' thumb='" + o + "' title='" + e.name + "' class='picasaImage picture ico' filetype='" + e.ext + "' style='margin:3px 0 0 8px;background:#fff url(\"" + o + "\") no-repeat center center;;'></div>",
			a += "<div id='" + e.name + "' class='titleBox'><span class='title' title='" + LNG.double_click_rename + "'>" + e.name + "</span></div></div>"
		} else a += "<div class='file fileBox menufile'" + _hover_title(e) + ">",
		a += "<div class='" + e.ext + " ico' filetype='" + e.ext + "'></div>",
		a += "<div id='" + e.name + "' class='titleBox'><span class='title' title='" + LNG.double_click_rename + "'>" + e.name + "</span></div></div>";
		return a
	};
	var o = function(e) {
		...
		n = "size" == G.sort_field || "ext" == G.sort_field ? n.sort(t("name", G.sort_order)) : n.sort(t(G.sort_field, G.sort_order)),
		o = o.sort(t(G.sort_field, G.sort_order)),
		G.json_data.folderlist = n,
		G.json_data.filelist = o;
		for (var r = "",
		l = "",
		c = 0; o.length > c; c++) r += this._getFileBox(o[c]);
	...
	r = function(e, a, t) {
		...
		if (void 0 == e && (e = !0), void 0 == a && (a = !1), e) $.ajax({
            //读取app列表
			url: "./admin.php?s=/explorer/pathList&path=" + G.this_path,
			dataType: "json",
			error: core.ajaxError,
			success: function(e) {
		...
		$.ajax({
            //读取回收站列表
			url: "./admin.php?s=/explorer/pathList&type=desktop&path=*recycle*/",
			dataType: "json",
			error: core.ajaxError,
			success: function(e) {
				if (!e.code) return ! 1;
	...
	c = function() {
		for (var e = 0; G.json_data.filelist.length > e; e++) G.json_data.filelist[e].atime = date(LNG.time_type, G.json_data.filelist[e].atime),
		...
		for (var e = 0; G.json_data.folderlist.length > e; e++) G.json_data.folderlist[e].atime = date(LNG.time_type, G.json_data.folderlist[e].atime),
	...
	return {
		...
		init: function() {
			...
			function() {
				ui.setStyle(),
				0 != PicasaOpen && e.setFrameResize(),
				s()
			}),
			$("html").die("click").live("click",
			function() {
				rightMenu.hidden(),
		...
		setTheme: function(e) {
			core.setSkin(e, "app_desktop.css"),
		...
		setWall: function(e) {
			$(".wallbackground").attr("src", e).one("load",
			function() {
...
function(e) {
	...
	var s = function(e, a, t) {
		if (void 0 != e) {
			...
			void 0;
			if (e == G.this_path) return void 0 != a && "" != a && core.tips.tips(LNG.path_is_current, "info"),
			void 0;
	...
	p = function(e) {
		var a = "",
		t = 0;
		return null != G.json_data.filelist && (a = d(G.json_data.filelist, "name", e), null != a && (t = 1)),
		null != G.json_data.folderlist && (a = d(G.json_data.folderlist, "name", e), null != a && (t = 1)),
		t
	},
	u = function(e, a) {
		var t, i = 0;
	...
	h = function() {
		$.ajax({
			dataType: "json",
			url: "./admin.php?s=/explorer/historyBack.html",
			beforeSend: function() {
	...
	f = function() {
		$.ajax({
			dataType: "json",
			url: "./admin.php?s=/explorer/historyNext.html",
			beforeSend: function() {
				$(".tools-left .msg").stop(!0, !0).fadeIn(100)
			},
			error: core.ajaxError,
	...
	m = function(e) {
		...
		s.unbind("keydown").keydown(function(e) {
			return (13 == e.keyCode || 27 == e.keyCode) && (stopPP(e), e.preventDefault(), filename = s.attr("value"), p(filename) ? ($("#makefile").remove(), core.tips.tips(LNG.path_exists, "warning")) : a.newFile(G.this_path + filename,
			function() {
				ui.f5_callback(function() {
					r(filename)
				})
		...
		s.unbind("blur").blur(function() {
			...
			p(filename) ? ($("#makefile").remove(), core.tips.tips(LNG.path_exists, "warning"), _newFile(e)) : a.newFile(G.this_path + filename,
			function() {
				ui.f5_callback(function() {
					r(filename)
				})
	...
	v = function() {
		...
		$(".newfile").unbind("keydown").keydown(function(e) {
			if (13 == e.keyCode || 27 == e.keyCode) {
				...
				p(t) ? ($("#makefile").remove(), core.tips.tips(LNG.path_exists, "warning")) : a.newFolder(G.this_path + t,
				function() {
					"explorer" == Config.pageApp && ui.tree.checkIfChange(G.this_path),
					ui.f5_callback(function() {
						r(t)
		...
		$(".newfile").unbind("blur").blur(function() {
			...
			p(filename) ? ($("#makefile").remove(), core.tips.tips(LNG.path_exists, "warning"), _newFolder()) : a.newFolder(G.this_path + filename,
			function() {
				"explorer" == Config.pageApp && ui.tree.checkIfChange(G.this_path),
				ui.f5_callback(function() {
					r(filename)
		...
		if (1 == i.length) {
			...
			o.keydown(function(l) {
				if (13 == l.keyCode) {
					...
					"oexe" == s && (e += ".oexe");
					var c = e;
					e != n ? (t = urlEncode(G.this_path + n), e = urlEncode(G.this_path + e), a.rname(t, e,
					function() {
						"explorer" == Config.pageApp && ui.tree.checkIfChange(G.this_path),
						ui.f5_callback(function() {
							r(c)
	...
	return {
		...
		share_open_window: function() {
			...
			var i = "./admin.php?s=/share/" + t + "&user=" + G.user_name + "&sid=" + a.sid;
			window.open(i)
		},
		...
		recycle_clear: function() {
			$.dialog({
				...
				ok: function() {
					$.ajax({
						url: "./admin.php?s=/explorer/pathDeleteRecycle.html",
						beforeSend: function() {
							core.tips.loading()
						},
						error: core.ajaxError,
		...
		explorerNew: function() {
			window.open("./admin.php?s=/explorer&path=" + y().path)
		},
...
function(e) {
	var a = {};
	a.file_info = e("../tpl/fileinfo/file_info.html"),
	a.path_info = e("../tpl/fileinfo/path_info.html"),
	a.path_info_more = e("../tpl/fileinfo/path_info_more.html");
	var t = ["/", "\\", ":", "*", "?", '"', "<", ">", "|"],
	i = function(e) {
		var a = function(e, a) {
			for (var t = a.length,
			i = 0; t > i; i++) if (e.indexOf(a[i]) > 0) return ! 0;
			return ! 1
		};
	...
	n = function(e) {
		for (var a = "list=[",
		t = 0; e.length > t; t++) a += '{"type":"' + e[t].type + '","path":"' + urlEncode2(e[t].path) + '"}',
		e.length - 1 > t && (a += ",");
		return a + "]"
	},
	s = function(e, a) {
	...
	d = function(e) {
		...
		1 > a.length || core.authCheck("userShare:set") && $.ajax({
			url: "./admin.php?s=/userShare/checkByPath&path=" + urlEncode(a),
			dataType: "json",
			success: function(e) {
				e.code ? p(e.data) : p(void 0,
				function() {
					$(".content_info input[name=type]").val(t),
					$(".content_info input[name=path]").val(a),
					$(".content_info input[name=name]").val(core.pathThis(a)),
					"file" == t && $(".label_code_read").addClass("hidden")
				})
			}
		})
	},
		...
		r = function() {
			...
			$(".share_action .share_create_button").unbind("click").click(function() {
				...
				$(".share_dialog .content_info input[name]").each(function() {
					...
					"checkbox" == $(this).attr("type") && (a = $(this).attr("checked") ? "1": ""),
					e += "&" + $(this).attr("name") + "=" + a
				}),
				$.ajax({
			...
			function() {
				...
				if (Global.isIE) {
					...
					i.moveEnd("character", -t.value.length),
	...
	h = function(e) {
		if (! (1 > e.length)) {
			...
			$.ajax({
				url: "./admin.php?s=/setting/set&k=wall&v=" + urlEncode(a),
				type: "json",
				success: function(e) {
					core.tips.tips(e)
				}
	...
	_ = function(e, a) {
		if (e) {
			var t = "./admin.php?s=/explorer/pathPast&path=" + urlEncode2(e);
			$.ajax({
				url: t,
				dataType: "json",
				beforeSend: function() {
	...
	g = function(e) {
		...
		var t = "./admin.php?s=/explorer/pathInfo";
		G.share_page !== void 0 && (t = "./admin.php?s=/share/pathInfo&user=" + G.user + "&sid=" + G.sid),
		$.ajax({
			url: t,
			type: "POST",
			dataType: "json",
			...
			error: core.ajaxError,
			success: function(t) {
				if (!t.code) return core.tips.close(t),
				void 0;
				...
				o = UUID();
				t.data.LNG = LNG,
				t.data.atime = date(LNG.time_type_info, t.data.atime),
				t.data.ctime = date(LNG.time_type_info, t.data.ctime),
				t.data.mtime = date(LNG.time_type_info, t.data.mtime),
				$.dialog({
					id: o,
					padding: 5,
					ico: core.ico("info"),
	...
	b = function(e) {
		if (core.authCheck("explorer:fileDownload") && !(1 > e.length)) {
			var a = "./admin.php?s=/explorer/zipDownload";
			G.share_page !== void 0 && (a = "./admin.php?s=/share/zipDownload&user=" + G.user + "&sid=" + G.sid),
			$.ajax({
				url: a,
				type: "POST",
				dataType: "json",
				...
				success: function(e) {
					core.tips.close(e),
					core.tips.tips(e);
					var a = "./admin.php?s=/explorer/fileDownloadRemove&path=" + urlEncode2(e.info);
					G.share_page !== void 0 && (a = "./admin.php?s=/share/fileDownloadRemove&user=" + G.user + "&sid=" + G.sid + "&path=" + urlEncode2(e.info));
	...
	k = function(e, a) {
		if (e) {
			var t = "./admin.php?s=/explorer/unzip&path=" + urlEncode2(e);
			$.ajax({
				url: t,
				beforeSend: function() {
	...
	j = function(e) {
		var a = {};
		return a.type = e.find("input[type=radio]:checked").val(),
		a.content = e.find("textarea").val(),
		a.group = e.find("[name=group]").val(),
	...
	T = function(e) {
		e.find(".type input").change(function() {
			...
			e.find("[data-type=" + a + "]").removeClass("hidden")
		})
	},
	S = function(a, t, i) {
			...
			},
			{
				...
				callback: function() {
					...
					case "user_add":
						...
						break;
					case "user_edit":
						s = "./admin.php?s=/app/user_app&path=" + urlEncode2(a.path);
						break;
					case "root_add":
						s = "./admin.php?s=/app/add&name=" + e.name;
						break;
					case "root_edit":
						s = "./admin.php?s=/app/edit&name=" + e.name + "&old_name=" + a.name;
						break;
					default:
					}
					$.ajax({
		...
		case "user_edit":
			...
			n.find("option[value=" + a.group + "]").attr("checked", !0);
			break;
		case "user_add":
			n.find(".desc").addClass("hidden"),
			n.find(".group").addClass("hidden"),
...
function(e) {
	var a = function(e, a) {
		if (void 0 != e) {
			if (void 0 == a && (a = core.pathExt(e)), a = a.toLowerCase(), "folder" == a) return "explorer" == Config.pageApp ? ui.path.list(e + "/") : core.explorer(e),
			void 0;
			if ("oexe" != a) {
	...
	i = function(e) {
		if (core.authCheck("explorer:fileDownload", LNG.no_permission_download) && e) {
			var a = "./admin.php?s=/explorer/fileDownload&path=" + urlEncode2(e);
			G.share_page !== void 0 && (a = "./admin.php?s=/share/fileDownload&user=" + G.user + "&sid=" + G.sid + "&path=" + urlEncode2(e));
			var t = '<iframe src="' + a + '" style="width:0px;height:0px;border:0;" frameborder=0></iframe>' + LNG.download_ready + "...",
			i = $.dialog({
				icon: "succeed",
				title: !1,
	...
	o = function(e) {
		if (core.authCheck("explorer:fileDownload", LNG.no_permission_download) && e) {
			...
			i = core.pathThis(e);
			if (inArray(core.filetype.bindary, t) || inArray(core.filetype.music, t) || inArray(core.filetype.image, t) || inArray(core.filetype.movie, t) || inArray(core.filetype.doc, t)) return a(e, t),
			void 0;
	...
	r = function(e) {
		...
		if ("" == G.office_server) {
			if (0 == a.search("localhost") || 0 == a.search("192.168.") || 0 == a.search("127.0.0")) return t(e, LNG.unknow_file_office + ', <a href="http://kalcaddle.com/help.html#office" target="_blank">' + LNG.more + ">></a>"),
			void 0;
		...
		function(a) {
			if (0 == a.code) return core.tips.tips(a),
			void 0;
			var t = G.app_host + "./admin.php?s=/user/public_link&fid=" + a.data,
...
function() {
	...
	i = function(e) {
		...
		for (a = e.length - 1; a >= 0; a--) {
			var i, n; - 1 == e[a].search("fileProxy") ? (i = urlEncode(e[a]), n = core.pathThis(e[a])) : (i = e[a], n = core.pathThis(urlDecode(i))),
			i = i.replace(/%2F/g, "/"),
			i = i.replace(/%3F/g, "?"),
			i = i.replace(/%26/g, "&"),
			i = i.replace(/%3A/g, ":"),
			i = i.replace(/%3D/g, "="),
			t += '<list><m type="" src="' + i + '" label="' + n + '"/></list>'
		}
		return t
	},
	n = function(e) {
	...
	return {
		changeTheme: function(a, t) {
			var i, s, o;
			"music" == a ? (G.musictheme = t, i = "music_player") : "movie" == a && (G.movietheme = t, i = "movie_player"),
			o = n(i),
			o && (s = e[t], window.top.art.dialog.list[i + "_dialog"].size(s.width, s.height), o.sendEvent("skin_load", "skins/" + s.path + ".zip"))
		},
		play: function(e, i) {
			var r = a(i),
			l = n(r);
...
var new_play = function(e) {
	...
	var t = function(e) {
		...
		return - 1 != t.indexOf("MSIE") ? a += 'classid="clsid:6BF52A52-394A-11d3-B153-00C04F79FAA6" ': ( - 1 != t.indexOf("Firefox") || -1 != t.indexOf("Chrome") || -1 != t.indexOf("Opera") || -1 != t.indexOf("Safari")) && (a += 'type="application/x-ms-wmp" '),
		a += 'width="100%" height="100%">',
		a += '<param name="URL" value="' + e + '">',
		a += '<param name="autoStart" value="true">',
		a += '<param name="autoSize" value="true">',
		a += '<param name="invokeURLs" value="false">',
		a += '<param name="playCount" value="100">',
		a += '<param name="Volume" value="100">',
		a += '<param name="defaultFrame" value="datawindow">',
		a += "</object>"
	};
	try {
