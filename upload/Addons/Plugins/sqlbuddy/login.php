...
$databaseconfig = require('../../../Application/Common/Conf/config.php');
ob_end_clean ();
...
<html xmlns="http://www.w3.org/1999/xhtml" version="-//W3C//DTD XHTML 1.1//EN" xml:lang="en">
	...
	<div id="loginform">
		...
		if ($ua && $ie && $ieVer < 7) {
			...
			<td><input type="text" class="text" name="HOST" value="<?php if(isset($_SESSION['onethink_admin']['user_auth']['uid'])) {$host = $databaseconfig['DB_HOST'];} echo $host; ?>" /></td>
			</tr>
			<tr>
			<td class="field"><?php echo __("Username"); ?>:</td>
			<td><input type="text" class="text" name="USER" value="<?php if(isset($_SESSION['onethink_admin']['user_auth']['uid'])) {$user = $databaseconfig['DB_USER'];} echo $user; ?>" /></td>
			</tr>
			<tr>
			<td class="field"><?php echo __("Password"); ?>:</td>
			<td><input type="password" class="text" name="PASS" value="<?php if(isset($_SESSION['onethink_admin']['user_auth']['uid'])) {$vpass = $databaseconfig['DB_PWD'];echo $vpass;} ?>" id="PASS" /></td>
			</tr>
			</table>
